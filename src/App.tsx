...
const educationData = [
  {
    ...
    degree: "BSc Computer Science – Awarded First Class Honours",
    duration: "2022 – 2025",
    details:
        ...
        <section id="about" className="max-w-4xl mx-auto py-24 px-6 relative">
          ...
          <div className="backdrop-blur-sm bg-white/5 p-6 rounded-lg border border-white/10 shadow-lg max-w-4xl text-charcoalBlack dark:text-gray-300 text-lg leading-relaxed">
            <img
              src="/image2.jpg"
              alt="Fabian Galasel"
              className="w-52 h-52 md:w-64 md:h-64 rounded-full border-2 border-orange dark:border-purple-500 object-cover md:float-left md:mr-6 mb-4 mx-auto"
              style={{
                shapeOutside: 'circle()',
                clipPath: 'circle()',
